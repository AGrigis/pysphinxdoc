...
.. [1] http://projects.scipy.org/numpy/wiki/CodingStyleGuidelines#
docstring-standard
...
from .docscrape_sphinx import (
    SphinxClassDoc, SphinxFunctionDoc, SphinxDocString)
...
def looks_like_issubclass(obj, classname):
    """ Return True if the object has a class or superclass with the given
    class name.
